...
new ElsaDataStack(app, "ElsaDataLocalDevTestStack", {
  ...
  serviceElsaData: {
    ...
    buildLocal: {
      folder:
        "../../artifacts/elsa-data-application-local-dev-test-docker-image",
    },
    metaConfigSources:
  ...
  serviceEdgeDb: {
    ...
    secretPrefix: "ElsaData", // pragma: allowlist secret
    dbUrlPort: 4000,
    dbUiUrlPort: 4001,
  },
});
...
new ElsaDataStack(app, "ElsaDataServerlessLocalDevTestStack", {
  ...
  serviceEdgeDb: {
    ...
    secretPrefix: "ElsaDataServerless", // pragma: allowlist secret
    dbUrlPort: 4000,
    dbUiUrlPort: 4001,
  },
});
